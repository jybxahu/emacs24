...
(defvar solarized-colors           ; ANSI(Solarized terminal)
  ...
  '((base03  "#002b36" "#042028" "#7f7f7f" "brightblack"   "black")
    (base02  "#073642" "#0a2832" "#000000" "black"         "black")
    (base01  "#586e75" "#465a61" "#00ff00" "brightgreen"   "green")
    (base00  "#657b83" "#52676f" "#ffff00" "brightyellow"  "yellow")
    (base0   "#839496" "#708183" "#5c5cff" "brightblue"    "blue")
    (base1   "#93a1a1" "#81908f" "#00ffff" "brightcyan"    "cyan")
    (base2   "#eee8d5" "#e9e2cb" "#e5e5e5" "white"         "white")
    (base3   "#fdf6e3" "#fcf4dc" "#ffffff" "brightwhite"   "white")
    (yellow  "#b58900" "#a57705" "#cdcd00" "yellow"        "yellow")
    (orange  "#cb4b16" "#bd3612" "#ff0000" "brightred"     "red")
    (red     "#dc322f" "#c60007" "#cd0000" "red"           "red")
    (magenta "#d33682" "#c61b6e" "#cd00cd" "magenta"       "magenta")
    (violet  "#6c71c4" "#5859b7" "#ff00ff" "brightmagenta" "magenta")
    (blue    "#268bd2" "#2075c7" "#0000ee" "blue"          "blue")
    (cyan    "#2aa198" "#259185" "#00cdcd" "cyan"          "cyan")
    (green   "#859900" "#728a05" "#00cd00" "green"         "green"))
