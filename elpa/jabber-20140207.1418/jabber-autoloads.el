...
;;;;;;  "jabber" "jabber.el" (21241 26764 43499 763000))
...
;;;;;;  "jabber-bookmarks" "jabber-bookmarks.el" (21241 26762 635499
;;;;;;  782000))
...
;;;***

;;;### (autoloads nil "jabber-core" "jabber-core.el" (21241 26762
;;;;;;  335499 786000))
...
;;;;;;  jabber-process-caps) "jabber-disco" "jabber-disco.el" (21241
;;;;;;  26763 527499 770000))
...
;;;;;;  "jabber-export.el" (21241 26762 735499 781000))
...
;;;;;;  "jabber-gmail.el" (21241 26762 903499 778000))
...
;;;***

;;;### (autoloads nil "jabber-keymap" "jabber-keymap.el" (21241 26763
;;;;;;  907499 765000))
...
;;;;;;  (21241 26761 879499 792000))
;;; Generated autoloads from jabber-menu.el

(defvar jabber-menu (let ((map (make-sparse-keymap "jabber-menu"))) (define-key-after map [jabber-menu-connect] '("Connect" . jabber-connect-all)) (define-key-after map [jabber-menu-nextmsg] '(menu-item "Next unread message" jabber-activity-switch-to :enable (bound-and-true-p jabber-activity-jids))) (define-key-after map [jabber-menu-disconnect] '(menu-item "Disconnect" jabber-disconnect :enable (bound-and-true-p jabber-connections))) (define-key-after map [jabber-menu-roster] '("Switch to roster" . jabber-switch-to-roster-buffer)) (define-key-after map [jabber-menu-status] `(menu-item "Set Status" ,(make-sparse-keymap "set-status") :enable (bound-and-true-p jabber-connections))) (define-key map [jabber-menu-status jabber-menu-status-chat] '("Chatty" lambda nil (interactive) (jabber-send-presence "chat" (jabber-read-with-input-method "status message: " *jabber-current-status* '*jabber-status-history*) *jabber-current-priority*))) (define-key map [jabber-menu-status jabber-menu-status-dnd] '("Do not Disturb" lambda nil (interactive) (jabber-send-presence "dnd" (jabber-read-with-input-method "status message: " *jabber-current-status* '*jabber-status-history*) *jabber-current-priority*))) (define-key map [jabber-menu-status jabber-menu-status-xa] '("Extended Away" . jabber-send-xa-presence)) (define-key map [jabber-menu-status jabber-menu-status-away] '("Away" . jabber-send-away-presence)) (define-key map [jabber-menu-status jabber-menu-status-online] '("Online" . jabber-send-default-presence)) (define-key-after map [separator] '(menu-item "--")) (define-key-after map [jabber-menu-customize] '("Customize" . jabber-customize)) (define-key-after map [jabber-menu-info] '("Help" . jabber-info)) map))
...
;;;;;;  jabber-muc-get-buffer) "jabber-muc" "jabber-muc.el" (21241
;;;;;;  26761 707499 794000))
...
;;;;;;  "jabber-muc-nick-completion.el" (21241 26763 731499 767000))
...
;;;;;;  "jabber-presence" "jabber-presence.el" (21241 26761 599499
;;;;;;  796000))
...
;;;;;;  "jabber-private.el" (21241 26762 567499 783000))
...
;;;;;;  "jabber-roster" "jabber-roster.el" (21241 26762 667499 781000))
...
;;;;;;  "jabber-rtt" "jabber-rtt.el" (21241 26763 975499 764000))
